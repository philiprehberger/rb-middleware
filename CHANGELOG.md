...
### Added
- `Stack#metrics` returning a whole-stack aggregate hash of `invocations`, `total_time`, `avg_time`, and `last_called_at` collected across every `#call` since construction
